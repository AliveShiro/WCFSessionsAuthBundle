 ...
 * @package xanily\WCFSessionsAuthBundle\Subscriber
 */
class WcfTablePrefixSubscriber implements EventSubscriber
{

    /**
     * Namespace the entity is in
     */
    private static $ENTITY_NAMESPACE = 'xanily\\WCFSessionsAuthBundle\\Entity';
